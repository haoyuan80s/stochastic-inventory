...
void DC_Exp(){
	...
	cout<<"In your inputfile, there should be just one number in the first line specify how many data sets you are going to generate. ";
	...
	cout<<" 0. You want to collect averaging data of sample path for given parameters OR you want to collect datas for a range of different PLANNING HORIZON. ";
	...
	cout<<" 7. Waht is your distribution type? (1: Binomial, 2: RA1 Bernoulli, 3: ind Normal)"<<endl;
	cout<<" 8. Waht are your distribution parameters?"<<endl;
	cout<<" 9. Whether your cost coefficient are going to be constant; (1 for const, 0 for vector)"<<endl;
	...
	cout<<endl;
	cout<<"If your answer is 2 for parameter 0, then for prameter 2(planning horizon), specify a number indicate how many different horizons, and follow by a vector"<<endl;
	cout<<endl;
