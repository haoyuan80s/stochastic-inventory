...
\section{The Model}
    ...
    \end{compactitem}
    Our goal is to choose $q_t$ at time $t$ to minimize the expected total cost from period $t$ to $T$. To do this we will find out the minimizer (or approximate minimizer) of the quantities below.\\ 
